...
#### ADD YOUR CODE HERE
driver_data = "driver/DriverData.txt"
driver = veh.ChDataDriver(vehicle, veh.GetDataFile(driver_data))
...
while (app.GetDevice().run())  :
    ...
    if(time <= 10):
       times.append(time)
       posX.append(vehicle.GetVehiclePos().x)
       posY.append(vehicle.GetVehiclePos().y)
       posZ.append(vehicle.GetVehiclePos().z)
    
plt.plot(times, posX , "-b", label = "X coordinates")
plt.plot(times, posY, "-r", label = "Y coordinates")
plt.title("Position of vehicle wrt to time")
plt.xlabel("Time in seconds")
plt.ylabel("Position of vehicle")
plt.legend()
plt.show()


plt.plot(times, posZ)
plt.title("Height of vehicle wrt to time")
plt.xlabel("Time in seconds")
plt.ylabel("Height of vehicle")
plt.show()
